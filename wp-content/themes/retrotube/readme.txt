...
== Changelog ==
= 1.14.0 = 2026-02-06
* Added: Add support for webp thumbnail file type in frontend video submit form
* Added: Add support for quicktime video file types in frontend video submit form
...
= 1.11.3 = 2025-12-04
* Fixed: Fix thumbnails issues in actors and categories pages
...
* Added: Set default thumbnail fit option from 16/9 to cover to display thumbnails correctly by default
* Updated: Update style versioning to use style.css file path for accurate cache busting
* Updated: Optimize thumbnail aspect ratio calculation in temp-style.php
* Updated: Optimize responsive player aspect ratio calculation
* Updated: Remove links to old wp-script demos sites in the options page

= 1.10.2 = 2025-08-25
* Fixed: Fix issue that prevented the views and likes from working correctly in video pages
* Fixed: Fix back to top button that was not displayed correctly in video pages
* Fixed: Fix readmore button on long description that was not displayed correctly in video pages
* Fixed: Fix issue that prevented photos galleries to be displayed correctly in video pages
* Fixed: Fix issue that prevented to switch from About to Share tabs in video pages

= 1.10.1 = 2025-08-11
* Updated: Improve JavaScript code when the mouse leaves a video trailer or thumbnail rotation

= 1.10.0 = 2025-08-07
* Added: Add support for gif and webp for trailers, in addition to mp4 and webm
* Updated: Optimize how trailers are loaded to save bandwidth and improve user experience
* Fixed: Fix featured video column in video list page that was not displayed correctly
* Fixed: Fix line height in error message when some html ads code are not well formed
